...
`mcp-defender-xdr` is a security tool. We take vulnerability reports
seriously and aim to acknowledge and remediate them quickly. Thank you
for taking the time to disclose responsibly.
...
- A minimal reproducer (proof-of-concept query, config, or steps).
- Affected version(s) — output of `mcp-defender-xdr --version` or the
