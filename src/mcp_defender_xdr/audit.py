...
_LOGGER_NAME = "mcp_defender_xdr.audit"
_ENV_LEVEL = "MCP_DEFENDER_XDR_LOG_LEVEL"
...
def _configure() -> logging.Logger:
    ...
    if getattr(logger, "_mcp_defender_xdr_configured", False):
        return logger
    ...
    logger._mcp_defender_xdr_configured = True  # type: ignore[attr-defined]
    return logger
